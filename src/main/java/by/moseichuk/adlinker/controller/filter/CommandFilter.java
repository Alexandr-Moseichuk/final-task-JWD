...
import by.moseichuk.adlinker.controller.command.application.*;
...
import by.moseichuk.adlinker.controller.command.user.UserListAction;
...
public class CommandFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        commandGet.put("/campaign/page", new CampaignPageVisual());
        commandGet.put("/not_approved", new NotApprovedVisual());
        ...
        commandPost.put("/user/list/action", new UserListAction());
    }
